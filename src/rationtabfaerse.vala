...
//Tab in dem Ration angezeigt wird
	...
	public void auswertungBauen(){
		...
		leistung.label7.set_text("ME(MJ)");
		grid20.add(leistung);
	...
	public void update(){
		...
		summe.auswertung.label7.set_text(doubleparse(sMittel.ME));
		...
		if (bedarf.length >= 2){
			...
			eMittel.ME = ((sMittel.ME - bedarf[0].fmMittel.ME) / bedarf[1].fmMittel.ME);
		}
		...
		ergebnis.auswertung.label7.set_text(doubleparse(eMittel.ME));
